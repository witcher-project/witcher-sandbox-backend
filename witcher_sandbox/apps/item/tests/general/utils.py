...
#
# from api.serializers.item_general import (
...
#
# from ...models.general import BaseItem, CraftingComponent, Recipe, RecipeComponent, Source, Tier, Type
#
#
...
#         self.user = self.core_manager.create_user(email="item.test.user@example.com", password="testpass")
...
#
#         model_to_url = {
#             CraftingComponent: "item:general:crafting-components-list",
#             Recipe: "item:general:recipes-list",
#             RecipeComponent: "item:general:recipes-components-list",
#             Source: "item:general:sources-list",
#         }
#         try:
...
#
#         model_to_url = {
#             CraftingComponent: "item:general:crafting-components-detail",
#             Recipe: "item:general:recipes-detail",
#             RecipeComponent: "item:general:recipes-components-detail",
#             Source: "item:general:sources-detail",
#         }
#         try:
...
#
#         model_to_url = {
#             CraftingComponent: "item:general:crafting-components-upload-img",
#             Recipe: "item:general:recipes-upload-img",
#             RecipeComponent: "item:general:recipes-components-upload-img",
#             Source: "item:general:sources-upload-img",
#         }
#         try:
#             return reverse(model_to_url[model], args=[id])
#         except KeyError:
...
#         instances of different models used in the Items witcher_sandbox.
#
#         Args:
