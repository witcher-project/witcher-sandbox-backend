...
class AlchemyModelTests(TestCase):
    ...
    def test_create_alchemy_instance(self):
        ...
        bomb = self.create_alchemy_instance(Bomb, name='Custom Bomb Name', price=150, effect='Custom Bomb Effect')
    ...
    def test_create_decotion(self):
        ...
        self.assertEqual(decotion.source, f'Same {decotion.__class__.__name__.lower()} source')
        self.assertEqual(decotion.link, f'Same {decotion.__class__.__name__.lower()} link')
    ...
    def test_create_potion(self):
        ...
        self.assertEqual(potion.source, f'Same {potion.__class__.__name__.lower()} source')
