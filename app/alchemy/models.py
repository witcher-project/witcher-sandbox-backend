...
class Decotion(BaseAlchemyElement):
    img = models.ImageField(upload_to='alchemy/decotions/', default='assets/default_decotion.png')
...
class Potion(BaseAlchemyElement):
    img = models.ImageField(upload_to='alchemy/potions/', default='assets/default_potion.png')
...
class Bomb(BaseAlchemyElement):
    img = models.ImageField(upload_to='alchemy/bombs/', default='assets/default_bomb.png')
